...
SWIFT_CLASS("_TtC12PlatformGame11AppDelegate")
...
@property (nonatomic, copy) NSArray<SKTexture *> * _Nonnull birdSprites;
@property (nonatomic, strong) SKSpriteNode * _Nonnull bird;
@property (nonatomic, strong) SKSpriteNode * _Nonnull myFloor1;
@property (nonatomic, strong) SKSpriteNode * _Nonnull myFloor2;
@property (nonatomic, strong) SKSpriteNode * _Nonnull bottomPipe1;
...
@interface SKNode (SWIFT_EXTENSION(PlatformGame))
+ (SKNode * _Nullable)unarchiveFromFile:(NSString * _Nonnull)file;
@end
